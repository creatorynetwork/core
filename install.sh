...
echo 'alias creatorynetwork="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/creatorynetwork/core.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/creatorynetwork/core.git'"
...
rm -rf "$HOME/.config/@creatorynetwork"
rm -rf "$HOME/.config/@creatorynetwork"
rm -rf "$HOME/.config/creatorynetwork-core"
